...
class Slider extends Component {
    constructor(props) {
        ...
        this.getIntervalBetweenSlides = this.getIntervalBetweenSlides.bind(this);
    ...
    componentDidMount() {
        this.interval = setInterval(() => this.getIntervalBetweenSlides(), 3000);
    }
    ...
    renderSlides() {
        ...
        return this.state.slides.map((it, i) => (
            <div className="each-slide" key={i} style={{backgroundImage: it.eachSlide, width: transition}}>
    ...
    renderDots() {
        return this.state.slides.map((it, i) => (
            <li className={this.isActiveDot(i) + ` dots`} key={i} ref="dots" onClick={this.getActiveDot.bind(this, i)}>
                <a>&#9679;</a>
            </li>
        ));
    }
    ...
    renderArrows() {
        return (
            <div>
                <button type="button" className="arrows prev" onClick={this.getPrevSlide}>
                    <svg fill='#FFFFFF' width='50' height='50' viewBox='0 0 24 24'>
                        <path d='M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z'/>
                        <path d='M0 0h24v24H0z' fill='none'/>
                    </svg>
                </button>
                <button type="button" className="arrows next" onClick={this.getNextSlide}>
